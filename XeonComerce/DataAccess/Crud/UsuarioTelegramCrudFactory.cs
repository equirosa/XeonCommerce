...
{
	public class UsuarioTelegramCrudFactory : CrudFactory
    {
        UsuarioTelegramMapper mapper;

        public UsuarioTelegramCrudFactory() : base()
        {
            mapper = new UsuarioTelegramMapper();
            dao = SqlDao.GetInstance();
        }

        public override void Create(BaseEntity entity)
        {
            var ent = (UsuarioTelegram)entity;
