...
const empleadoModule = () =>
  import("./empleado/empleado.module").then((x) => x.EmpleadoModule);
...
const routes: Routes = [
  ...
  {
    path: "crearcomercio",
    component: CrearComercioComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "citasComercio",
    component: ListCitaComercioComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "usuario/:id",
